...
#define CONFIG_FILE "GTB.MatchServer.cfg"
#define LOGCAT_NAMESPACE "MatchServer"
#define LOGCAT_CONFIG_FILE "GTB.MatchServerLogCat.xml"
...
public:
	...
	bool start()
	{
		...
		match::server::instance().set_on_stop_event(on_server_stop, this);
		return match::server::instance().start();
	}
