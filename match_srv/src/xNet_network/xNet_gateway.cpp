...
namespace xNet {
	...
	{
		REG_MSG(protocol::internal_register_player_req);
		REG_MSG(protocol::internal_unregister_player_req);
		REG_MSG(protocol::internal_create_ps_ans);
	}
