...
namespace xNet {
	...
	public:
		...
		xNet::socket* create_socket(uint64 ref_id=0);
		void destroy_socket(xNet::socket* sock);
	...
	private:
		...
		static void message_dispatch(xNet::socket* sock, const xNet::address& dest, StreamPtr& msg, void* context);
